...
\
{
  NavItem, MysterySetKey, PerspectiveType
  \
}
from
;("@/types")
...
export const ANIMATIONS = \
{
  beadRevealDelay: 0.4, // seconds between each bead\
    lineRevealDelay
  : 2.5, // seconds before line appears
...
export const NAV_ITEMS: NavItem[] = [\
  \{ name: "WHAT", label: "WHAT", icon: HelpCircle \},\
...
{
  email: "rosarynarrated@gmail.com", youtube
  : "https://www.youtube.com/@20RosaryDecades-Narrated",
...
{
  monthlySupport: "https://stripe.com/monthly-support", oneTimeDonation
  : "https://stripe.com/one-time-donation",
