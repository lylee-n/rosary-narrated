    ...
    <div className="container mx-auto px-4 py-16">
      <div className="text-center mb-16">
        ...
        <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto font-inter font-light leading-relaxed">
          We're building something meaningful here – mak the Rosary connects people across the globe. Your support helps us keep the lights on and reach more people who need this.
        </p>
      </div>
