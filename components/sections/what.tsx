      ...
      <div className="container px-4 md:px-6">
        <div className="flex flex-col items-center space-y-4 text-center mb-12">
          <div className="space-y-2">
            <h1 className="font-sora text-3xl font-bold tracking-tighter sm:text-5xl md:text-6xl">Rosary Narrated</h1>
        ...
        <div className="mx-auto grid max-w-5xl items-stretch gap-6 sm:grid-cols-2 md:grid-cols-3 lg:gap-8">
          <Card className="flex flex-col text-center border-2 border-transparent hover:border-primary transition-all duration-300 bg-card">
            <CardHeader className="items-center">
              ...
              <CardTitle className="font-sora text-xl">Story-driven Audio</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="flex flex-col text-center border-2 border-transparent hover:border-primary transition-all duration-300 bg-card">
            <CardHeader className="items-center">
              ...
              <CardTitle className="font-sora text-xl">Visual Rosary Experience</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground">
          ...
          <Card className="flex flex-col text-center border-2 border-transparent hover:border-primary transition-all duration-300 bg-card">
            <CardHeader className="items-center">
              ...
              <CardTitle className="font-sora text-xl">Interactive Prayer Beads</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground">
