      ...
      >
        ...
        <div className="container relative mx-auto px-4 z-10 py-16 lg:py-24">
          <div className="grid lg:grid-cols-3 gap-8 lg:gap-12">
            ...
            <div className="w-full flex flex-col relative rounded-xl overflow-hidden border border-white/20 bg-white/10 backdrop-blur-sm shadow-2xl">
            ...
            <div className="w-full flex flex-col relative rounded-xl overflow-hidden border border-white/20 bg-white/10 backdrop-blur-sm shadow-2xl">
              <div className="relative z-10 flex flex-col h-full p-6">
                ...
                <div className="flex-1 space-y-4 text-white/90 leading-relaxed">
                  ...
                  <p>
                    Saints and popes throughout the centuries have praised the Rosary as one of the most effective forms
                    of prayer for obtaining graces and spiritual protection.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="w-full flex flex-col relative rounded-xl overflow-hidden border border-white/20 bg-white/10 backdrop-blur-sm shadow-2xl">
              <div className="relative z-10 flex flex-col h-full p-6">
                <h3 className="text-white font-sora text-2xl font-bold mb-6">The 15 Promises</h3>
