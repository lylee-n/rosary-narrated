        ...
        >
          <div>
            ...
            <input
              ...
              required
              className="w-full px-4 py-3 bg-gray-800/50 border border-gray-600 rounded-md text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#FFE552] focus:border-transparent"
          ...
          <div>
            ...
            <textarea
              ...
              required
              rows={6}
              className="w-full px-4 py-3 bg-gray-800/50 border border-gray-600 rounded-md text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#FFE552] focus:border-transparent resize-vertical"
